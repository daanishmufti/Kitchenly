  ...
  return (
    <div className="about-container">
      <div className="about-card">
        ...
        <h2 style={{color: '#2d7a46', fontSize: '1.3rem', marginBottom: '0.7rem'}}>Our Mission</h2>
        <p>
        ...
        <h2 style={{color: '#2d7a46', fontSize: '1.3rem', marginBottom: '0.7rem'}}>What You’ll Find Here</h2>
        <ul style={{textAlign: 'left', margin: '0 auto 1.5rem auto', maxWidth: 400, color: '#444', fontSize: '1.05rem'}}>
        ...
        <h2 style={{color: '#2d7a46', fontSize: '1.3rem', marginBottom: '0.7rem'}}>Join Our Community</h2>
        <p>
        ...
        <p style={{marginTop: '2rem', color: '#888', fontSize: '0.98rem'}}>
